var bitcoin_repl = (function() {
    ...
    var op_defs = {
        ...
        OP_EQUAL: [         0,  0, true, false, function() { return []; }],
        OP_EQUALVERIFY: [   0,  0, true, false, function() { return []; }],
        OP_1ADD: [          0,  0, true, false, function() { return []; }],
        OP_1SUB: [          0,  0, true, false, function() { return []; }],
        OP_2MUL: [          0,  0, false, false, function() { return []; }],
        OP_2DIV: [          0,  0, false, false, function() { return []; }],
        OP_NEGATE: [        0,  0, true, false, function() { return []; }],
        OP_ABS: [           0,  0, true, false, function() { return []; }],
