...
QUnit.test( "Test OP_3DUP", function( assert ) {
    var testedCommands = {
        "OP_1 OP_2 OP_3 OP_4 OP_3DUP": "0x01 0x02 0x03 0x04 0x02 0x03 0x04"
    };
...
QUnit.test( "Test OP_2ROT", function( assert ) {
    var testedCommands = {
        "OP_1 OP_2 OP_3 OP_4 OP_5 OP_6 OP_7 OP_2ROT": "0x01 0x04 0x05 0x06 0x07 0x02 0x03"
    };
...
QUnit.test( "Test OP_2SWAP", function( assert ) {
    var testedCommands = {
        "OP_1 OP_2 OP_3 OP_4 OP_5 OP_6 OP_7 OP_2SWAP": "0x01 0x02 0x03 0x06 0x07 0x04 0x05"
    };
...
QUnit.test( "Test OP_IFDUP", function( assert ) {
    var testedCommands = {
